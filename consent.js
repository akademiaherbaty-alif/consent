...
gtag('consent', 'default', defaultConsentPageView[0]);
}
...
for (let i = 0; i < text.length; i++) {
  ...
  if (text[i].style.display === "none") {
    ...
    toggleButton.innerHTML = "Pokaż mniej";
  } else {
    text[i].style.display = "none";
    toggleButton.innerHTML = "..Pokaż więcej";
  }
}
}
...
console.log("consent banner + consent setup by metricsrealm.com")